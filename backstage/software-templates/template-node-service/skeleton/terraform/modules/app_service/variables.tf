...
variable "vpc_tag_filters" {
  description = "Tag filters to discover the VPC when vpc_id is not provided"
  type        = map(string)
  default     = {}
}

variable "public_subnet_tag_filters" {
  description = "Tag filters to discover public subnets when IDs are not provided"
  type        = map(string)
  default     = {}
}

variable "private_subnet_tag_filters" {
  description = "Tag filters to discover private subnets when IDs are not provided"
  type        = map(string)
  default     = {}
}
